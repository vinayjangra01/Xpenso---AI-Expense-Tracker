...
const ContactPage = () => {
  return (
    <div className='font-sans bg-gradient-to-br from-slate-50 via-white to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900/20 text-slate-800 dark:text-slate-200 transition-all duration-300 min-h-screen'>
      {/* Hero Section */}
      <section className='relative overflow-hidden flex flex-col items-center justify-center text-center py-16 sm:py-20 md:py-24 px-4 sm:px-6 md:px-8 bg-gradient-to-br from-indigo-500/10 via-purple-500/5 to-blue-500/10 dark:from-indigo-900/30 dark:via-purple-900/20 dark:to-blue-900/30'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto w-full'>
          ...
          <p className='text-base sm:text-lg md:text-xl lg:text-2xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed px-2 sm:px-0'>
            Questions about AI-powered expense management? Our team is ready to help you optimize your financial workflow.
          </p>
        ...
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-10 sm:mb-12 md:mb-16'>
            ...
            <p className='text-sm sm:text-base md:text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto px-2 sm:px-0'>
              Reach our AI support team through your preferred channel. We're here to help optimize your expense management.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8'>
            <div className='group relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-xl border border-slate-100/50 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1 text-center'>
              ...
              <div className='relative z-10'>
                <div className='w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-indigo-500 via-purple-500 to-blue-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg mb-4 sm:mb-6 mx-auto'>
                ...
                <p className='text-sm sm:text-base text-slate-600 dark:text-slate-400 mb-3 sm:mb-4 leading-relaxed'>
                  Get detailed assistance with your questions. Our AI-enhanced support typically responds within 24 hours.
                </p>
                <a
                  href='mailto:support@expensetracker-ai.com'
            ...
            <div className='group relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-xl border border-slate-100/50 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1 text-center'>
              ...
              <div className='relative z-10'>
                <div className='w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-purple-500 via-blue-500 to-indigo-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg mb-4 sm:mb-6 mx-auto'>
                  <span className='text-white text-lg sm:text-xl'>📱</span>
                </div>
                <h3 className='text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-slate-900 dark:text-slate-100'>
                  Phone Support
            ...
            <div className='group relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-6 sm:p-8 rounded-xl sm:rounded-2xl shadow-xl border border-slate-100/50 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-200 hover:-translate-y-1 text-center sm:col-span-2 lg:col-span-1'>
              ...
              <div className='relative z-10'>
                <div className='w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg mb-4 sm:mb-6 mx-auto'>
                  <span className='text-white text-lg sm:text-xl'>📍</span>
                </div>
                <h3 className='text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-slate-900 dark:text-slate-100'>
                  Office Location
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8'>
            <div className='bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-slate-100/50 dark:border-slate-700/50'>
              <div className='flex items-center gap-3 mb-4'>
                <div className='w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-indigo-500 via-purple-500 to-blue-500 rounded-md sm:rounded-lg flex items-center justify-center shadow-lg'>
              ...
              <div className='space-y-2 text-sm sm:text-base text-slate-600 dark:text-slate-400'>
                ...
                <div className='mt-4 p-3 bg-indigo-50 dark:bg-indigo-900/30 rounded-lg'>
                  <p className='text-xs sm:text-sm text-indigo-700 dark:text-indigo-300'>
                    <strong>AI Email support:</strong> Available 24/7 with responses within 24 hours
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-lg border border-slate-100/50 dark:border-slate-700/50'>
              <div className='flex items-center gap-3 mb-4'>
                <div className='w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-purple-500 via-blue-500 to-indigo-500 rounded-md sm:rounded-lg flex items-center justify-center shadow-lg'>
                  <span className='text-white text-xs sm:text-sm'>💡</span>
                </div>
                <h3 className='text-lg sm:text-xl font-bold text-slate-900 dark:text-slate-100'>
                  Quick Help
              ...
              <div className='space-y-3'>
                <div className='p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg'>
                  ...
                  <p className='text-xs text-slate-600 dark:text-slate-400'>
                    App not working? Check our troubleshooting guide first.
                  </p>
                </div>
                <div className='p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg'>
                  <h4 className='font-semibold text-slate-900 dark:text-slate-100 text-xs sm:text-sm mb-1'>
                  ...
                  <p className='text-xs text-slate-600 dark:text-slate-400'>
                    Questions about AI insights? Our documentation has answers.
                  </p>
                </div>
                <div className='p-3 bg-slate-50 dark:bg-slate-700/50 rounded-lg'>
                  <h4 className='font-semibold text-slate-900 dark:text-slate-100 text-xs sm:text-sm mb-1'>
                  ...
                  <p className='text-xs text-slate-600 dark:text-slate-400'>
                    Account or billing questions? Contact us directly.
                  </p>
                </div>
              </div>
            </div>
